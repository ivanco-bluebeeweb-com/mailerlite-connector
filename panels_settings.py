"""Settings panel for MailerLite Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__mailerlite_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=mailerlite_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_mailerlite"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("MailerLite Settings & Accounts", level=2),
